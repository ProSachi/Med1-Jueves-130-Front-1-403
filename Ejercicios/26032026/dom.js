...
console.log(divPrimero)
let divSegundo = document.getElementById("segundo");
console.log(divSegundo)
let divTercero = document.getElementById("tercero");
console.log(divTercero)


let divclaseprimera = document.getElementsByClassName("contenedor");
console.log(divclaseprimera)
...
for (let index = 0; index < h3.length; index++) {
    h3[index].style.backgroundColor = '#e80a0a';
} */
...
let quiero = document.querySelector('.contenedor')
quiero.style.color = 'purple';
quiero.innerHTML = librosStock;
